...
if(!isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] != true){
  ...
  $con = $db->conectar();
  $estado='activo';
  $sql=$con->prepare("SELECT ciudadoresguar.cod_empresa,  ciudadoresguar.nombre, ciudad.nombre as ciudad,  ciudadoresguar.telefono,ciudadoresguar.direccion,  ciudadoresguar.servicios,  ciudadoresguar.correo, ciudadoresguar.situacion  FROM ciudadoresguar INNER JOIN ciudad ON ciudadoresguar.ciudad=ciudad.cod_ciudad WHERE situacion='2'");
  $sql->execute();
  $resultado=$sql->fetchAll(PDO::FETCH_ASSOC);

  if(!$resultado){
    echo'
      <script>alert("No se han encontrado Empresas bloqueadas");
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <a href="bloqueadas.php" class="active">
    ...
    <div id="main-container">
      ...
      <?php foreach($resultado as $row ){ ?>
			<tr class="usuario">
                ...
                <th><a href="activar.php?di=<?php echo $row['cod_empresa'];?>&token=<?php echo hash_hmac('sha1',$row['cod_empresa'], KEY_TOKEN);?>">Desbloquear</a></th>
